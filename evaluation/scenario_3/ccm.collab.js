      ...
      this.start = function ( callback ) {
        ...
        window.ccm.dstore(this.dstore, (db) => {
          ...
          textElement.addEventListener('keyup', () => {
            ...
            // The key written is used to calculate latency 
            // in this benchmark
            store.set({ key: currentFile, data: editedText, written: new Date().valueOf() })
          });
          ...
          newFileButton.addEventListener('click', (e) => {
            ...
            store.set({ key: file, data: "", written: new Date().valueOf() }, (newFile) => {
